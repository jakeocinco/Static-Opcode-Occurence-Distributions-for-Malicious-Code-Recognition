...
def reduce_op_code_list_to_index_list(
    ...
    for line_index, line in enumerate(op_code_occurence_list):
        ...
        if operation in file_operations:
            # if REVERSED_MAP[operation] in file_operations:
